...
model_configs.append(
    {'model_name': 'DetectoRS (ResNet-50)',
     'paper_arxiv_id': '2006.02334',
     'weights_url': 'http://cs.jhu.edu/~syqiao/DetectoRS/DetectoRS_R50-0f1c8080.pth',
     'weights_name': 'DetectoRS_R50-0f1c8080.pth',
     'config': './configs/DetectoRS/DetectoRS_mstrain_400_1200_r50_40e.py',
     'paper_results': {'box AP': 0.513, 'AP50': 0.701, 'AP75': 0.558, 'APS': 0.317, 'APM': 0.546, 'APL': 0.648}}
)

model_configs.append(
    {'model_name': 'DetectoRS (ResNeXt-101-32x4d)',
     'paper_arxiv_id': '2006.02334',
     'weights_url': 'https://www.cs.jhu.edu/~syqiao/DetectoRS/DetectoRS_X101-ed983634.pth',
     'weights_name': 'DetectoRS_X101-ed983634.pth',
     'config': './configs/DetectoRS/DetectoRS_mstrain_400_1200_x101_32x4d_40e.py',
     'paper_results': {'box AP': 0.547, 'AP50': 0.735, 'AP75': 0.601, 'APS': 0.374, 'APM': 0.573, 'APL': 0.664}}
)
